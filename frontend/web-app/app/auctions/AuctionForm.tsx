        ...
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
            ...
            <>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    ...
                    <DateInput name='auctionend' label='Auction end date/time' type='date' control={control} rules={{ required: 'Auction end date is required' }} showTimeSelect dateFormat='dd MMMM yyyy h:mm a' />
                </div>
            </>}
